...
from utils import get_model_name, load_config, plot_bev, plot_label_map, plot_image
...
def inference(image_id = 0):
    ...
    image = loader.dataset.get_image(image_id)
    ...
    with torch.no_grad():
        ...
        print("FPS Forward Pass:", 1 / (time.time() - t_start))
        ...
        print("Number of bounding boxes after NMS:", len(corners))
        print("FPS Non-max suppression:", 1 / (time.time() - t_start))
