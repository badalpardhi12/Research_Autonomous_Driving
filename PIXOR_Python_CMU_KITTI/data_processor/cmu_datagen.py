...
class KITTI(Dataset):
    ...
    def __init__(self, frame_range = 10000, use_npy=False, train=False):
        self.frame_range = frame_range
        self.velo = []
        self.use_npy = use_npy

        self.image_sets = self.load_imageset(train = False) # names
    ...
    def load_imageset(self, train):
        ...
        if train:
            ...
            path = os.path.join(path, "cmu.txt")
    ...
    def get_image(self, index):
        index = self.image_sets[index]
        path = KITTI_PATH + "/cmu/image_2/" + str(index) + ".jpg"
    ...
    def load_velo_scan(self, item):
        ...
        # print("\n\n"+filename + "\n\n")
        # print("\n\n",np.fromfile(filename, dtype=np.float32).shape ,"\n\n")
    ...
    def load_velo(self):
        ...
        for file in self.image_sets:
            ...
            velo_files.append(os.path.join(KITTI_PATH, 'cmu', 'velodyne', file))
...
def get_cmu_data_loader(batch_size, use_npy, frame_range=10000):
